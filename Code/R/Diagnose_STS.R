...
plot_individual_fit(path_fit_data, path_obs_data, path_save, 1, print_fig = T)
...
# ------------------------------------------------------------------------------------------------------------------------
path_to_obs_data <- "../../Intermediate/Data_whole_tidy_filt.csv"
path_pred_data <- "../Matlab/STS/Model2_short_del/Result/Predicted_fits.csv"
path_save <- "../../Result/Figures/Model2_short_del_STS/STS_model2_obs_vs_pred.pdf"
plot_obs_vs_pred_STS(path_to_obs_data, path_pred_data, path_save, print_fig = T)

# The residuals 
path_to_residuals <- "../Matlab/STS/Model2_short_del/Result/Residuals.csv"
path_to_obs_data <- "../../Intermediate/Data_whole_tidy_filt.csv"
path_save_time <- "../../Result/Figures/Model2_short_del_STS/STS_model2_res_time.pdf"
path_save_obs <- "../../Result/Figures/Model2_short_del_STS/STS_model2_res_obs.pdf"
plot_residuals_STS(path_to_residuals, path_to_obs_data, path_save_time, path_save_obs, save_time = T, print_fig = T)
plot_residuals_STS(path_to_residuals, path_to_obs_data, path_save_time, path_save_obs, save_time = F, print_fig = T)

# The individual fits 
path_fit_data <- "../Matlab/STS/Model2_short_del/Result/Individual_fits.csv"
path_to_obs_data <- "../../Intermediate/Data_whole_tidy_filt.csv"
path_save <- "../../Result/Figures/Model2_short_del_STS/STS_model2_ind_fit_"
plot_individual_fit(path_fit_data, path_obs_data, path_save, 74, print_fig = T)
plot_individual_fit(path_fit_data, path_obs_data, path_save, 73, print_fig = T)
plot_individual_fit(path_fit_data, path_obs_data, path_save, 10, print_fig = T)
...
n_parameters <- 12
name_param <- c("k1", "k2", "k3", "k4", "k5", "k6", "k7", "k8", "k9", "k10", "Suc2", "Glc0", "Cost")
path_param <- "../Matlab/STS/Model2_short_del/Result/Parameters_and_cost_func.csv"
path_save_hist <- "../../Result/Figures/Model2_short_del_STS/STS_model2_hist_ind_param.pdf"
path_save_qq <- "../../Result/Figures/Model2_short_del_STS/STS_model2_qq_ind_param.pdf"
check_dist_ind_param_STS(path_param, name_param, n_parameters, path_save_hist, path_save_qq, save_hist = T)
check_dist_ind_param_STS(path_param, name_param, n_parameters, path_save_hist, path_save_qq, save_hist = F)
...
path_param <- "../Matlab/STS/Model2_short_del/Result/Parameters_and_cost_func.csv"
n_parameters <- 12
path_save_file <- "../../Result/Files/STS_model2_short_del_cov_mean.csv"
calc_mean_and_cov_param(path_param, name_param, n_parameters, path_save_file)
